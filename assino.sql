...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2023 at 04:41 PM
...
--
-- Constraints for table `guard_attendance`
--
ALTER TABLE `guard_attendance`
  ADD CONSTRAINT `guard_attendance_ibfk_1` FOREIGN KEY (`guard_id`) REFERENCES `guards` (`id`);
